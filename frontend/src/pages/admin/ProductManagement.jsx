    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-screen text-left space-y-8">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-dark-900 border border-slate-200/50 dark:border-dark-800/50 p-16 rounded-3xl text-center">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 max-w-sm mx-auto mt-2">Click "Add New Product" to populate Henco's list of interlocks and pavers.</p>
        </div>
      ) : (
                  ...
                  <tr key={prod._id} className="hover:bg-slate-50/50 dark:hover:bg-dark-900/50">
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-0.5">
                        <span className="font-extrabold text-gray-900 dark:text-white block leading-tight">{prod.name}</span>
                        {prod.isFeatured && (
